...
var nicEditorConfig = bkClass.extend({
	buttons : {
		'bold' : {name : __('Click Negritas'), command : 'Bold', tags : ['B','STRONG'], css : {'font-weight' : 'bold'}, key : 'b'},
		'italic' : {name : __('Click Italica'), command : 'Italic', tags : ['EM','I'], css : {'font-style' : 'italic'}, key : 'i'},
		'underline' : {name : __('Click Subrrayada'), command : 'Underline', tags : ['U'], css : {'text-decoration' : 'underline'}, key : 'u'},
		...
		'ol' : {name : __('Insertar Lista en Orden'), command : 'insertorderedlist', tags : ['OL']},
		'ul' : 	{name : __('Insertar Lista Inorden'), command : 'insertunorderedlist', tags : ['UL']},
...
var nicColorOptions = {
	buttons : {
		'forecolor' : {name : __('Cambiar Color de Text '), type : 'nicEditorColorButton', noClose : true},
		'bgcolor' : {name : __('Cambiar Color de fondo '), type : 'nicEditorBgColorButton', noClose : true}
	}
};
/* END CONFIG */
...
var nicImageOptions = {
	buttons : {
		'image' : {name : 'Adicionar imagen', type : 'nicImageButton', tags : ['IMG']}
	}
...
var nicImageButton = nicEditorAdvancedButton.extend({	
	...
	submit : function(e) { alert(this.inputs['src'].value);
...
var nicUploadButton = nicEditorAdvancedButton.extend({	
	nicURI : 'http://localhost:8383/nicEdit/demos',
